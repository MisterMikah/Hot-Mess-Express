...
//handles the player's interactions with the food. When a food item is clicked, it gets copied and gets dropped on the plate.
...
public class ClickPlace : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        if (gameObject.name == "burger_bread_1")
            Instantiate(cloneObj, new Vector3(3, .01f, -2), cloneObj.rotation);
